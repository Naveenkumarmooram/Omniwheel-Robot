...
class JoyClass:
    def __init__(self, scale=1.0, offset=0.0, deadband=0.1):
        ...
        self.wheel1_pub = rospy.Publisher("/omni/rim_wheel2_joint/command", Float64, queue_size=10)
        self.wheel2_pub = rospy.Publisher("/omni/rim_wheel3_joint/command", Float64, queue_size=10)
        self.wheel3_pub = rospy.Publisher("/omni/rim_wheel4_joint/command", Float64, queue_size=10)
        self.wheel4_pub = rospy.Publisher("/omni/rim_wheel1_joint/command", Float64, queue_size=10)
